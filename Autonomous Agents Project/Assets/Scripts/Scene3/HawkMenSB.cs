...
public class HawkMenSB : MonoBehaviour
{
    List<HawkMenController> behaviours = new List<HawkMenController>();
    ...
    void Start()
    {
        ...
        HawkMenController[] behaviours = GetComponents<HawkMenController>();

        foreach (HawkMenController b in behaviours)
        {
